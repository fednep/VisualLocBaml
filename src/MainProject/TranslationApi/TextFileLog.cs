...
namespace TranslationApi
{
    ...
    {
        public string __LogData;

        public void LogLine(string logLine, LogSeverity severity = LogSeverity.Info)
        {
            __LogData += LogStringFormatter.FormatMessage(logLine, severity);
        }
