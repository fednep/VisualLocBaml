...
{
    class RecentProjectMore
    {
        private List<RecentProject> __MoreProjects;

        public RecentProjectMore(List<RecentProject> moreProjects)
        {
            __MoreProjects = moreProjects;
        }
