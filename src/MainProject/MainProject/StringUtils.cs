...
namespace MainProject
{
    class StringUtils
    {
        ...
        {
            return (string)App.Current.MainWindow.FindResource(key);
        }

        static public string String(string key, params object[] objs)
        {
            return System.String.Format(
                (string)App.Current.MainWindow.FindResource(key), objs);
        }
